...
$all_categories = get_terms(['taxonomy' => 'Konkursy_categories', 'hide_empty' => false]);
...
<main class="main-wrap">
    <div class="container">
        ...
        <!-- Posts List -->
        <div class="articles-wrap list-layout">
            <div class="row">
                                ...
                                <a href="<?php the_permalink(); ?>" class="article-card-inner d-flex flex-column">
                                    ...
                                    <div class="article-card-content d-flex flex-column">
                                        <div class="meta-type d-flex align-items-center">
                                            ...
                                            <?php
                                            $wydarzen_terms = get_the_terms(get_the_ID(), 'Konkursy_categories');
